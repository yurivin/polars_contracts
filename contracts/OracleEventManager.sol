...
contract OracleEventManager is Ownable {
    ...
    IEventLifeCycle internal _eventLifeCycle;
    IPredictionPool internal _predictionPool;

    uint256 public _priceChangePart;
    string public _eventName;
    string public _downTeam;
    string public _upTeam;
    ...
    function prepareEvent() external {
        ...
        if (
            ...
            gameEvent = GameEvent({
                ...
                blackTeam: (_lastEventId % 2 == 0) ? _upTeam : _downTeam,
                whiteTeam: (_lastEventId % 2 == 0) ? _downTeam : _upTeam,
